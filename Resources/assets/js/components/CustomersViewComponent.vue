          ...
          <b-card-text>
            ...
            <table class="table table-striped">
              ...
              <tr>
                ...
                <td>
                  <b-badge v-if="customer.verification_guid === ''" class="badge-soft-primary"><i
                      class="fas fa-check-circle"></i> Account Verified
                  </b-badge>
                  <b-badge v-if="customer.verification_guid !== ''" class="badge-soft-danger"><i
                      class="fas fa-times-circle"></i> Not Verified
                  </b-badge>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <b-badge v-if="helpers.hasActiveSubscription(customer)" class="badge-soft-primary"><i
                      class="fas fa-check-circle"></i>Subscribed
                  </b-badge>
                  <b-badge v-if="!helpers.hasActiveSubscription(customer)" class="badge-soft-standard"><i
                      class="fas fa-times-circle"></i>Unsubscribed
                  </b-badge>
                </td>
              </tr>
            </table>
          ...
          <b-card-text>
            ...
            <b-table striped :fields="orderFields" :items="customer.orders" responsive="sm" sortDesc>
              ...
              <template v-slot:cell(actions)="data">
                <a v-b-tooltip:hover title="View Order" :href="'/admin/orders/view/' + data.item.unique_id"
