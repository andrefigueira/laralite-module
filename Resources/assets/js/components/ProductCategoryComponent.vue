    ...
    <div>
        ...
        <table class="table" v-show="showResults">
            ...
            <tr v-for="productCategory in productCategories">
                ...
                <td>
                    <b-button @click="confirmDelete(productCategory)" variant="default" size="sm" class="float-right"><i class="far fa-trash-alt"></i></b-button>
                    <a :href="'/admin/product-category/edit/' + productCategory.id" class="btn btn-sm btn-default float-right mr-1"><i class="far fa-edit"></i></a>
                </td>
            </tr>
        </table>
    </div>
